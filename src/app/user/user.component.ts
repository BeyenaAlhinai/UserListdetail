// Import necessary modules from Angular and PrimeNG
    ...
    this.items = [
      {
        ...
        items: [
          ...
          { label: 'User Registration', icon: 'pi pi-fw pi-video' },
          { label: 'User List', icon: 'pi pi-fw pi-bookmark' ,   command: (event: any) => {
            this.showDialog();      }},
